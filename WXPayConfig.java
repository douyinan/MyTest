...
public abstract class WXPayConfig {
	...
	public int getHttpConnectTimeoutMs() {
		return Variable.POSITION_6 * Variable.POSITION_1000;
	}
	...
	public int getHttpReadTimeoutMs() {
		return Variable.POSITION_8 * Variable.POSITION_1000;
	}
