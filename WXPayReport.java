...
public class WXPayReport {
	...
	public void report(String uuid, long elapsedTimeMillis, String firstDomain, boolean primaryDomain,
		...
		if (data != null) {
			boolean r = reportMsgQueue.offer(data);
			WXPayUtil.getLogger().info("offer result {}", r);
		}
	}
	 ...
	 * @throws Exception
	 */
	private static String httpRequest(String data, int connectTimeoutMs, int readTimeoutMs) throws SystemException {
